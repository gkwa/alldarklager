...
import (
	...
	"github.com/gkwa/alldarklager/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.alldarklager.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".alldarklager")
	}
